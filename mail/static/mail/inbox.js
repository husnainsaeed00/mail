...
function load_mailbox(mailbox) {
  ...
  .then(emails => {
    ...
    // Loop through the meial and create a div forr each
    emails.forEach(singleEmail =>{
      //Create a div for each email and show it on the screen
      const newEmail = document.createElement('div');
      newEmail.className="list-group-item";
      newEmail.innerHTML = ` <h5>Sender:${singleEmail.sender}</h5>
